...
Alongside the previous setting, **Required Stars To Remove** dictates the amount of stars a starboard message must fall to before being removed from the starboard.
...
- reacting on a message sent by a user that is blacklisted
- reacting on a bot's message when **Filter Bots** is enabled
- reactions in a blacklisted channel
- reacting on a message that doesn't pass message filters
