...
<Aside type="note" title="Beating the misconceptions">
    ...
    - Additionally,
        - only emojis set as upvote or downvote emojis will be added by auto-star.
        - auto-star is not a standalone feature; you must have a starboard configured for it to work.
</Aside>
